        ...
        <View>
            <View style={styleText.container}>
                ...
                <View style={styleText.localizacaoWrapper}> 
                    ...
                    <Text style={styleText.text}>83833-014</Text>
                </View>

                <View style={styleText.localizacaoWrapper}> 
                    <Text style={styleText.text}>Endereço: </Text>
                    <Text style={styleText.text}>Rua Manoel Claudino Barbosa</Text>
                </View>

                <View style={styleText.localizacaoWrapper}> 
                    <Text style={styleText.text}>Bairro: </Text>
                    <Text style={styleText.text}>Pioneiros</Text>
                </View>

                <View style={styleText.localizacaoWrapper}> 
                    <Text style={styleText.text}>Cidade: </Text>
                    <Text style={styleText.text}>Fazenda Rio Grande</Text>
                </View>

                <View style={styleText.localizacaoWrapper}> 
                    <Text style={styleText.text}>Estado: </Text>
                    <Text style={styleText.text}>PR</Text>
                </View>

                <View style={styleText.localizacaoWrapper}>  
                    <Text style={styleText.text}>Número: </Text>
                    <Text style={styleText.text}>5565</Text>
                </View>

                <View style={styleText.localizacaoWrapper}> 
                    <Text style={styleText.text}>Telefone para contato: </Text>
                    <Text style={styleText.text}>(62)3259-5648</Text>
                </View>
